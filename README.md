...
* [`Inertia Table`](https://inertiaui.com/inertia-table?utm_source=github&utm_campaign=laravel-guidelines): The Ultimate Table for Inertia.js with built-in Query Builder.
